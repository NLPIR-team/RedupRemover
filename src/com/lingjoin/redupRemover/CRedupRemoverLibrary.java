...
public interface CRedupRemoverLibrary extends Library {

	CRedupRemoverLibrary instance = (CRedupRemoverLibrary) Native.loadLibrary("LJRedupRemover", CRedupRemoverLibrary.class);
